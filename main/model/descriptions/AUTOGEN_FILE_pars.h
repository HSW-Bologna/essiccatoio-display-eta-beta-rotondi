...
typedef enum {
    PARS_FLOW_CHECK_TYPE_INGRESSO = 0,
    PARS_FLOW_CHECK_TYPE_PRESSOSTATO,
} pars_flow_check_type_t;

extern const char *pars_flow_check_type[2][2];
typedef enum {
...
typedef enum {
    ...
    PARS_DESCRIPTIONS_CONTROLLO_ARIA,
    PARS_DESCRIPTIONS_PRESSIONE_VENTILAZIONE_MINIMA,
    PARS_DESCRIPTIONS_PRESSIONE_VENTILAZIONE_MASSIMA,
    PARS_DESCRIPTIONS_PRESSIONE_VENTILAZIONE_LAVORO,
    PARS_DESCRIPTIONS_PRESSIONE_VENTILAZIONE_SICUREZZA,
} pars_descriptions_t;

extern const char *pars_descriptions[61][2];
typedef enum {
