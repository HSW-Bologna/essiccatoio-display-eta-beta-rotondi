...
void parmac_init(mut_model_t *model, int reset) {
    ...
    ps[i++] = PARAMETER(&p->max_output_temperature,                   1,                              85,                         75,                             FFINT(PARS_DESCRIPTIONS_TEMPERATURA_MASSIMA_IN_USCITA, fmt_c),                USER_BITS);
    ps[i++] = PARAMETER(&p->safety_output_temperature,                1,                              90,                         85,                             FFINT(PARS_DESCRIPTIONS_TEMPERATURA_DI_SICUREZZA_IN_USCITA, fmt_c),                USER_BITS);
